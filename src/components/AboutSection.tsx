      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start mb-16">
            ...
            >
              <div className="premium-card p-8 border border-border/50 rounded-2xl bg-card/30 backdrop-blur-sm shadow-xl">
              ...
              <div className="flex flex-wrap gap-4">
                <motion.div 
                  ...
                  className="stat-card flex-1 min-w-[120px] text-center p-6 border border-border/50 rounded-2xl bg-card/30 backdrop-blur-sm"
                >
                  <div className="text-3xl font-bold text-primary">400+</div>
                  <div className="text-sm text-muted-foreground mt-2">DSA Problems</div>
                </motion.div>
                <motion.div 
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="stat-card flex-1 min-w-[120px] text-center p-6 border border-border/50 rounded-2xl bg-card/30 backdrop-blur-sm"
                >
                  ...
                  <div className="text-sm text-muted-foreground mt-2">Global Rank</div>
                </motion.div>
                <motion.div 
                  whileHover={{ scale: 1.05, y: -5 }}
                  className="stat-card flex-1 min-w-[120px] text-center p-6 border border-border/50 rounded-2xl bg-card/30 backdrop-blur-sm"
            ...
            <motion.div
              ...
              className="flex-1 grid grid-cols-2 gap-2 sm:gap-4 w-full"
            >
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="flex-box-feature text-center flex flex-col items-center justify-center p-6 cursor-pointer"
                >
                  <motion.div 
