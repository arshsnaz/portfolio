...
const projects = [
  ...
  {
    title: "Prescripto - Book Doctor Appointments",
    subtitle: "Healthcare Booking System",
    description: "Team-built Java full-stack healthcare platform for seamless doctor appointments with scheduling, notifications, and role-based access.",
    techStack: ["Java", "Spring Boot", "React.js", "MySQL"],
    image: doctorLogo,
    metrics: [{ value: "Team", label: "Collaboration" }, { value: "Java", label: "Full Stack" }],
    status: "Completed",
    featured: false,
  ...
  },
  {
    ...
    image: rcLogo,
    metrics: [{ value: "Real", label: "Business Use" }, { value: "Order", label: "Management" }],
    status: "Completed",
    featured: false,
