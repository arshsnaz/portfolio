...
import { Calendar, MapPin, TrendingUp, FileText, ExternalLink } from "lucide-react";
import jazarLogo from "../assets/jazar-logo.png";
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-8">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-white flex items-center justify-center flex-shrink-0 border-2 border-primary/30 overflow-hidden">
                    <img src={jazarLogo} alt="Jazar Technology Logo" className="w-full h-full object-cover" />
                  </div>
                  <div>
